...
<head>
  ...
  <title>Form Input Barang Keluar</title>
...
<body>
  ...
  <div class="container">
    ...
    <form action="" method="post">
      <table>
        <tr>
          ...
          <td>:</td>
          <td><input type="text" name="kd_brng_keluar" id="kd_brng_keluar" required></td>
        </tr>
        <tr>
          <td><label for="kd_barang">Kode Barang</label></td>
          <td>:</td>
          <td><input type="text" name="kd_barang" id="kd_barang" required></td>
        </tr>
        <tr>
    ...
    <br>
    <a href="tampil-barang-keluar.php">Liat Item Barang Keluar</a>
  </div>
