<?php 
  ...
  $kd = $_GET["kd"];
  $br = masukkan("SELECT * FROM barang WHERE kd_barang = '$kd'")[0];
    ...
    <form action="" method="post">
      <table>
        <tr>
          ...
          <td>:</td>
          <td><input type="text" name="kd_barang" id="kd-barang" required value="<?= $br["kd_barang"];?>"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td><input type="number" name="stok" id="stok" required value="<?= $br["stok"];?>"></td>
        </tr>
        <tr>
