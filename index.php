<?php
    ...
    $jumlahData = count(masukkan("SELECT * FROM barang"));
    $jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
    $halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
    $awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;
    
    $barang = masukkan("SELECT * FROM barang LIMIT $awalData, $jumlahDataPerhalaman");
...
<html lang="en">
  <head>
    ...
    <title>Tampilan Web Opname</title>
  ...
  <body class="d-flex flex-column">
    ...
    <section>
      <div class="container">
        <h1 class="mb-3">Tampilan Barang</h1>
